 ...
 * @author itt
 */
public class ViolationDataException extends BaseRuntimeException {
     ...
     * @param code 오류코드
     */
    public ViolationDataException(String code) {
     ...
     * @param cause 원인예외
     */
    public ViolationDataException(String code, Throwable cause) {
     ...
     */
    public ViolationDataException(String code, Object[] codeMessageArgs) {
     ...
     * @param cause 원인예외
     */
    public ViolationDataException(String code, Object[] codeMessageArgs, Throwable cause) {
